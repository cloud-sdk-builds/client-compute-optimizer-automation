...
[`@aws-sdk/client-compute-optimizer-automation`](https://www.npmjs.com/package/@aws-sdk/client-compute-optimizer-automation/v/3.1078.0).
...
- @aws-sdk/client-compute-optimizer-automation v3.1078.0 - [https://cloud-sdk-builds.github.io/?sdk=client-compute-optimizer-automation&version=3.1078.0](https://cloud-sdk-builds.github.io/?sdk=client-compute-optimizer-automation&version=3.1078.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-compute-optimizer-automation@3.1078.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T4RlJX9goqP9OAZWwltL1qTapo0lT/q28wBCPWwxIf/bzuG/SrY6y7+ZHFRM1SDZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-compute-optimizer-automation": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-compute-optimizer-automation@3.1078.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-compute-optimizer-automation@3.1078.0/index.min.mjs": "sha384-T4RlJX9goqP9OAZWwltL1qTapo0lT/q28wBCPWwxIf/bzuG/SrY6y7+ZHFRM1SDZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-compute-optimizer-automation/blob/refs/tags/3.1078.0/LICENSE
```
