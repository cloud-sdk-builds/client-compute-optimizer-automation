...
[`@aws-sdk/client-compute-optimizer-automation`](https://www.npmjs.com/package/@aws-sdk/client-compute-optimizer-automation/v/3.1079.0).
...
- @aws-sdk/client-compute-optimizer-automation v3.1079.0 - [https://cloud-sdk-builds.github.io/?sdk=client-compute-optimizer-automation&version=3.1079.0](https://cloud-sdk-builds.github.io/?sdk=client-compute-optimizer-automation&version=3.1079.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-compute-optimizer-automation@3.1079.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LMFZrXRF4ovD7/m7aGdu1d5+2dMb2hpR6tMfMQdsDQ/7qD+++G+FYGUp0uF8om2Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-compute-optimizer-automation": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-compute-optimizer-automation@3.1079.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-compute-optimizer-automation@3.1079.0/index.min.mjs": "sha384-LMFZrXRF4ovD7/m7aGdu1d5+2dMb2hpR6tMfMQdsDQ/7qD+++G+FYGUp0uF8om2Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-compute-optimizer-automation/blob/refs/tags/3.1079.0/LICENSE
```
