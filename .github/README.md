...
[`@aws-sdk/client-compute-optimizer-automation`](https://www.npmjs.com/package/@aws-sdk/client-compute-optimizer-automation/v/3.939.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-compute-optimizer-automation@3.939.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sa65pPJKDyhUTR+Wrwi0CrirwEUs/bEs7sja588Bma4UjoenI66GCv8W7SpwM+ZI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-compute-optimizer-automation": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-compute-optimizer-automation@3.939.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-compute-optimizer-automation@3.939.0/index.min.mjs": "sha384-sa65pPJKDyhUTR+Wrwi0CrirwEUs/bEs7sja588Bma4UjoenI66GCv8W7SpwM+ZI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-compute-optimizer-automation/blob/refs/tags/3.939.0/LICENSE
```
